declare cursor c1 is select  * from temp_subve  where dflag is null and eflag is null and length(name) < 70 order by id;
...
(AGENT_CODE,AGENT_NAME,agent_disc_percent,agent_rdisc_percent,ctn_No,
