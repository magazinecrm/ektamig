declare cursor c1 is select  * from temp_subve  where dflag = 'YY' and length(name) < 70 order by id;
...
(cust_Type,AGENT_CODE,AGENT_NAME,agent_disc_percent,agent_rdisc_percent,ctn_No,
...
CURRENCY)
values
(xxx.category,null,null,null,null,mctn_no,
null,2223,null,xxx.name,xxx.phone,null,null,'migration',
