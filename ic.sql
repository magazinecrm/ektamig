declare cursor c1 is select  * from temp_subvep  where mflag = 'er' and id = 648  ;
...
(id,mdesc,cust_Type,AGENT_CODE,AGENT_NAME,agent_disc_percent,agent_rdisc_percent,ctn_No,
...
CURRENCY)
values
(xxx.id,'plutod',xxx.category,null,null,null,null,mctn_no,
