...
select  * from temp_subve where dflag  = 'ZA'  order by id;
...
begin
            ...
            loop
               warn('zzzzz');
                msubscriber_no  := find_snoADD(xxx.name,xxx.ADD_);  
...
*/
  ...
  (id,mdesc,paid_date,manual_pid,cust_Type,ctn_no,postal,ono,sub_status,membership_number,tran_type,subscriber_no,subscriber_type,company,fullname,res_address1,
                     ...
                     values 
(xxx.id,'forsa',to_date(xxx.receipt_date,'yyyy-mm-dd'),xxx.SUB__REC__BILL_NO,mcust_Type,mctn_no,mpostal,null,'ACTIVE','axmno',null,msubscriber_no,'PAID',mCOMPANY,mfullname,mres_add1,
