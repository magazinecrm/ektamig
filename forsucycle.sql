...
select  * from temp_subv where ddflag  is  null and 
mflag is null order by id;
...
*/
  ...
  (id,mdesc,paid_date,manual_pid,cust_Type,ctn_no,postal,ono,sub_status,membership_number,tran_type,subscriber_no,subscriber_type,company,fullname,res_address1,
                     ...
                     values 
(xxx.id,'acticyle',to_date(xxx.receipt_date,'yyyy-mm-dd'),xxx.SUB__REC__BILL_NO,mcust_Type,mctn_no,mpostal,null,'ACTIVE','axmno',null,msubscriber_no,'PAID',mCOMPANY,mfullname,mres_add1,
